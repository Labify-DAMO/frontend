...
//    
//    // ✅ Type을 ETC, LAB, PICKUP으로 변경
//    private let facilityTypes = ["ETC", "LAB", "PICKUP"]
//    
//    var body: some View {
//        NavigationStack {
//            VStack(spacing: 24) {
...
//                            .cornerRadius(10)
//                            .disabled(viewModel.hasFacility)
//                    }
//                    
//                    VStack(alignment: .leading, spacing: 8) {
//                        Text("시설 유형")
...
//                        .cornerRadius(12)
//                }
//                .disabled(viewModel.hasFacility || !confirmAccuracy || !formValid || viewModel.isLoading)
